    ...
    <body >
        ...
        <div class="story-image" id="story">   
            <div class="container">
                <div class=" row">
                    <div class="col-sm-6">
                        <h1 class="display-3" style="padding-top:10% " data-aos="fade-up" data-aos-duration="800" data-aos-easing="ease-in-quad">Our Story</h1>
                        <p class="lead" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-quad">
                            The Mondstadt Library is an online bookstore with a mission to financially support local, independent bookstores.
            ...
            <div class="testimonial text-center">
                <div class="container">
                    <div class="heading white-heading">
                        <h3 class="display-3" data-aos="fade-up" data-aos-duration="800" data-aos-anchor-placement="bottom-bottom">Our Happy Customer</h3>
                    </div>
